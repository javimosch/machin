...
| cyberpunk | **infinite** procedural world: fbm-noise terrain streamed in GPU-mesh chunks, fly camera, neon buildings | **`noise2`/`noise3`** Perlin noise (v0.49.0) |

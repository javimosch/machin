...
| cyberpunk | **infinite** procedural world: fbm-noise terrain streamed in GPU-mesh chunks, fly camera, grimy buildings, **shader depth fog** | **`noise2`/`noise3`** Perlin noise (v0.49.0); buildings/scatter/fog = composition |

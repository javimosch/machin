...
| cyberpunk | **infinite** procedural world: fbm-noise terrain in GPU-mesh chunks, fly camera, grimy city districts, **GPU-instanced flora**, **shader depth fog** | **`noise2`/`noise3`** Perlin (v0.49.0); buildings/instancing/shaders/fog all composition |

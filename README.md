...
`examples/` holds 23 programs, each a `.mfl`. `make examples` runs them all.
...
| `complex/fizzbuzz` | `%` modulo, string returns, branching |
| `complex/leap_year` | `&&` / `\|\|` boolean operators, slice iteration |

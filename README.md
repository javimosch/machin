<p align="center">
  <img src="https://img.shields.io/badge/version-0.64.0-blue" alt="Version">
...
- **Databases**: embedded **SQLite** (`sqlite_*`), a pure-MFL **PostgreSQL** client (`framework/postgres.src` — wire protocol + SCRAM-SHA-256, no libpq; rows as JSON that `parse(rows, []T{})` decodes), and a pure-MFL **Redis** client (`framework/redis.src` — RESP; cache/sessions/queues)
